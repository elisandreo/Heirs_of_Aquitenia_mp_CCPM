...
country = {
	...
	NAVAL_BASE_NON_CORE_SUPPLY_SCORE = 0.4, -- modifier for supply score for naval bases that are not in core provinces.
...
economy = {
	...
	SECOND_RANK_BASE_SHARE_FACTOR = 0.2,
	CIV_BASE_SHARE_FACTOR = 0.35,
	UNCIV_BASE_SHARE_FACTOR = 0.5,
